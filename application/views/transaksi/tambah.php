...
<div class="main-content" id="main-content">
    ...
    <div class="container mt-4">
        <form method="post" action="<?= base_url('index.php/transaksi/simpan') ?>">
            ...
            <input type="number" name="jumlah" id="jumlah" class="form-control" oninput="hitungTotal()" required>
            ...
            <div class="input-group">
                ...
                <input type="number" name="dp" id="dp" class="form-control" oninput="cekStatus()">
            </div>
...
<script>
    ...
    // Mengisi harga dari data option
    window.onload = function () {
        ...
        for (let i = 0; i < options.length; i++) {
            ...
            barangHarga[option.value] = parseInt(option.getAttribute('data-harga')) || 0;
        }
    ...
    function cekStatus() {
        ...
        statusField.value = dp >= total ? 'Lunas' : 'Belum';
    }
</script>
